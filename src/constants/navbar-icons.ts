const homeIcon = `<svg viewBox="0 0 30 30" fill="none">
                    <path
...
const aboutIcon = "info";
const servicesIcon = "build";
const contactIcon = "contact_mail";

export { homeIcon, aboutIcon, servicesIcon, contactIcon };