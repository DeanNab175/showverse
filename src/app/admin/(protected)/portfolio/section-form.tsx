...
import { portfolioSectionSchema } from "@/lib/schemas/project-schema";

import { updatePortfolioSection } from "./actions";

const formSchema = portfolioSectionSchema.extend({
...
function SectionForm({ defaultValues }: SectionFormProps) {
  const [state, formAction, isActionPending] = useActionState(updatePortfolioSection, undefined);
